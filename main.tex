...
% Submissão anônima — autores e filiações omitidos conforme normas do evento
\author{Autores omitidos para revisão cega\inst{1}}
\address{\inst{1} Filiação omitida para revisão cega}
